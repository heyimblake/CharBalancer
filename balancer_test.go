...
var (
	CurlyBracketsGroup  = NewCharacterGroup(0x7B, 0x7D)
	AngleBracketsGroup  = NewCharacterGroup(0x3C, 0x3E)
	ParenthesisGroup    = NewCharacterGroup(0x28, 0x29)
	SquareBracketsGroup = NewCharacterGroup(0x5B, 0x5D)
)
